<nav class="sidebar sidebar-offcanvas" id="sidebar">
  <ul class="nav">
    <li class="nav-item nav-profile">
      <div class="nav-link">
        ...
        <div class="profile-name">
          <p class="name">Md Sohanur Rahaman</p>
    ...
    <li class="nav-item">
      <a class="nav-link" data-toggle="collapse" href="#category-pages" aria-expanded="false" aria-controls="general-pages"> <span class="menu-title">Manage Category</span><i class="menu-arrow"></i></a>
    ...
    <li class="nav-item">
      <a class="nav-link" data-toggle="collapse" href="#brand-pages" aria-expanded="false" aria-controls="brand-pages"><span class="menu-title">Manage Brand</span><i class="menu-arrow"></i></a>
